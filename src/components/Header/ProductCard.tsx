...
export default function ProductCard({ thumbnail, productName, productPrice, quantity }: ProductCardProps) {
    return (
        <div className="flex max-h-[8vh] gap-4 items-center mx-4">
            ...
            <div className="max-w-[50vw]">
                ...
                <p>${productPrice} X {quantity} <strong>${quantity * productPrice}</strong></p>
            </div>
