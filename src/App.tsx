...
export default function App() {
  ...
  return (
    <>
      ...
      <footer className="mt-12 m-4">
        <p>Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" className="text-blue-400">
          Frontend Mentor
        </a>.</p>
        <p>Coded by <a href="https://github.com/fabiomoretao" target="_blank"
